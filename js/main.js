...
function renderVisualization(bookList) {
  ...
  unreadList.innerHTML = '<p id="empty-unread" class="empty-text">You have no book in this list</p>';
  const readList = document.getElementById('read-list');
  // readList.innerHTML = '';
  readList.innerHTML = '<p id="empty-read" class="empty-text">You have no book in this list</p>';
...
function createItemList(book) {
  ...
  btnTrash.classList.add('btn', 'btn-trash');
